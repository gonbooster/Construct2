...
(function ()
{
    ...
    Acts.prototype.SaveInstances = function (objtype, is_pick_all)
    {
        if (!objtype)
            return;  
...
(function ()
{
    ...
    {       
        ...
        return this.CreateShellInstance(uid);     
    };
    
    InstBankKlassProto.CreateShellInstance = function(uid)
    {       
        var status = this.bank[uid];
        if (status == null)
            return;
    ...
    InstBankKlassProto.LoadInstance_step1 = function(inst, uid, skip_siblings)
    {
        ...
        if (inst == null)
            inst = this.CreateShellInstance(uid);        
