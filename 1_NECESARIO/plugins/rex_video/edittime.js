function GetPluginSettings()
{
	return {
		...
		"help url":		"https://dl.dropboxusercontent.com/u/5779181/C2Repo/rex_video.html",
		"category":		"Media",
...
AddCondition(3, 0, "Is playing", "Control", "Is playing", 
             "Is video playing.", "IsPlaying");  
AddCmpParam("Comparison", "Choose the way to compare the distance travelled.");
AddNumberParam("Current time", "Current time, in seconds.");
AddCondition(4, 0, "Compare current time", "Current time", "Current time {0} {1}", "Compare the current time.", "CompareCurrentTime");
...
AddNumberParam("Seconds", "Target time, in seconds", 0);
AddAction(11, 0, "Seek", "Control", "Seek to <i>{0}</i> seconds", "Seek to target time.", "Seek");
//AddObjectParam("Canvas", "Canvas object to paste.");
//AddAction(12, 0, "Paste", "Canvas", "Paste current image to <i>{0}</i>", "Paste current image to canvas object.", "Image2Canvas");

////////////////////////////////////////
// Expressions
AddExpression(0, ef_return_number, "Get current time", "Current time", "CurrentTime", "Get current video time, in seconds.");
